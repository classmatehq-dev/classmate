        ...
        <div className="mt-auto space-y-3 border-t border-border px-3 pt-4">
          ...
          <Link
            ...
            className={cx(
              ...
              isActive("/settings")
                ? "bg-light-blue text-brand-blue"
                : "text-muted hover:bg-light-blue/60 hover:text-navy",
            )}
          >
            <svg
              viewBox="0 0 24 24"
            ...
            >
              ...
              <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.2.63.77 1.05 1.42 1.05H21a2 2 0 0 1 0 4h-.09c-.65 0-1.22.42-1.51 1z" />
            </svg>
            Settings
          </Link>
          <AccountControl authMode={authMode} className="px-3 text-sm font-semibold text-muted hover:text-navy" />
        </div>
      </nav>
